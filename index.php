...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">DoubleH</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Bus ticket with DoubleH</h1>

            <p class="text-center">Welcome Demo Project2.</p>
    ...
    <div id="block">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> Hữu Hòa && Xuân Hòa | Made with &#10084;&#65039; by DoubleH
                        </p>
        </footer>
    </div>
